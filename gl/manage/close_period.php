...
function check_data()
{
	...
	{
//      don't allow close date earlier than previous one
...
if (get_post('submit'))
	...
	Only transactions which can generate GL postings are subject to the constraint.<br>
	WARNING: This action can NOT be undone. So do a backup first!"));
